...
public final class CommandExecutionUtil {
    ...
    @Nonnull
    public static CompletableFuture<Void> execute(@Nullable PlayerRef playerRef, @Nonnull String command, boolean runAsServer) {
        ...
        if (permissions.isEmpty()) {
            return commandManager.handleCommand(playerRef, processedCommand);
        }

        return grantPermissionTemporarily(
                playerRef,
                permissions,
                () -> commandManager.handleCommand(playerRef, processedCommand)
        );
    }
    ...
    @Nonnull
    private static CompletableFuture<Void> grantPermissionTemporarily(@Nonnull PlayerRef playerRef, @Nonnull Set<String> permissions, @Nonnull Supplier<CompletableFuture<Void>> callback) {
